...
export default function Backup() {
  ...
  async function doBackup() {
    ...
    try {
      ...
      setCurrentTbl('Génération du fichier JSON...')
      setProgress(85)
      ...
      a.href = url; a.download = `EnviroControl_backup_${date}.json`
    ...
    <div className="space-y-6 max-w-2xl">
      ...
      <div className="card p-5">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-5">
          Télécharge toutes les données dans un fichier JSON sur votre PC.
        ...
        {done && !loading && (
          <div className="flex items-center gap-2 text-green-600 text-sm font-medium mb-4 bg-green-50 dark:bg-green-900/20 px-4 py-3 rounded-lg border border-green-200">
            <CheckCircle size={16}/>
            Sauvegarde téléchargée avec succès ! Copiez le fichier JSON vers le dossier réseau.
          </div>
        )}
